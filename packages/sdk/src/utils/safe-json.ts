 ...
 * - NaN, Infinity, and invalid dates (converted to null)
 */
 ...
 */
export function jsonStringifyReplacer(_key: string, val: unknown): unknown {
 ...
 */
export function serializeWithPathTracking(value: unknown, path: Set<object>): string {
