...
/*
 * Context membership/lifecycle helpers (contextAddMember, contextRemoveMember,
 * contextIsMember, contextMembers, contextCreate, contextDelete,
 * contextResolveAlias) were removed: the node provides no matching host
 * functions, so importing them made JS modules fail to instantiate. Context
 * membership is managed out-of-band via the admin API / merobox workflows.
 */
